<template>
  <div id="app">
    ...
    <div style="height: 500px; width: 500px; margin: 20px; border: 1px solid red; position: relative;">
      ...
      <VueDraggableResizable :x="50" :y="50" :w="150" :h="50" :parent="true" :resizable="false"
    ...
    <div style="height: 500px; width: 500px; margin: 20px; border: 1px solid red; position: relative;">
      ...
      <VueDraggableResizable :x="50" :y="50" :w="150" :h="50" :parent="true" :grid="[30, 30]" :resizable="false"
                             :dragHandle="'.dragHandle'">
        <p>Component</p>
        <span class="dragHandle">
          =
...
<script>
  import VueDraggableResizable from '../components/DraggableResizable.vue';
