      ...
      handleMove: function(e) {
        ...
        if (this.resizing) {
          if (this.handle.indexOf('t') >= 0) {
            ...
            else if (this.parent && this.elmY + dY < this.parentY) this.mouseOffY = (dY -
          ...
          if (this.handle.indexOf('b') >= 0) {
            ...
            else if (this.parent && this.elmY + this.elmH + dY > this.parentH) this.mouseOffY = (dY -
              (diffY = this.parentH - this.elmY - this.elmH));
            this.elmH += diffY;
          }
          if (this.handle.indexOf('l') >= 0) {
            if (this.elmW - dX < this.minw) this.mouseOffX = (dX - (diffX = this.elmW - this.minw));
            else if (this.parent && this.elmX + dX < this.parentX) this.mouseOffX = (dX -
          ...
          if (this.handle.indexOf('r') >= 0) {
            ...
            else if (this.parent && this.elmX + this.elmW + dX > this.parentW) this.mouseOffX = (dX -
          ...
          if (this.parent) {
            ...
            else if (this.elmX + this.elmW + dX > this.parentW) this.mouseOffX = (dX -
              (diffX = this.parentW - this.elmX - this.elmW));
            if (this.elmY + dY < this.parentY) this.mouseOffY = (dY - (diffY = this.parentY - this.elmY));
            else if (this.elmY + this.elmH + dY > this.parentH) this.mouseOffY = (dY -
              (diffY = this.parentH - this.elmY - this.elmH));
          }
          this.elmX += diffX;
          this.elmY += diffY;
